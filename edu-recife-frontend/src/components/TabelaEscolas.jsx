...
import DetalheEscola from './DetalheEscola';
  ...
  return (
    <>
      <div className="card">
        ...
        {totalPaginas > 1 && (
          <div className="paginacao">
            <button className="pag-btn" onClick={() => irPara(pagina - 1)} disabled={pagina === 1}>
              ‹ Anterior
            </button>
            ...
            <button className="pag-btn" onClick={() => irPara(pagina + 1)} disabled={pagina === totalPaginas}>
              Próxima ›
            </button>
          </div>
        )}
      ...
      <DetalheEscola
        ...
        onFechar={() => setEscolaSelecionada(null)}
      />
    </>
  );
};
